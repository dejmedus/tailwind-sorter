    ...
    <main className="flex flex-col justify-between items-center p-24 min-h-screen">
      ...
      <div className="grid lg:grid-cols-4 mb-32 lg:mb-0 lg:w-full lg:max-w-5xl lg:text-left text-center">
        <a
          ...
          className="group hover:bg-gray-100 hover:dark:bg-neutral-800/30 px-5 py-4 border border-transparent hover:border-gray-300 hover:dark:border-neutral-700 rounded-lg transition-colors"
          target="_blank"
          rel="noopener noreferrer"
        >
